  ...
  return (
    <div className="animate-fade">
      ...
      <div style={{
        ...
        <input className="input" style={{ width: '100%', maxWidth: isMobile ? 'none' : 240 }} placeholder="🔍 Search name or roll number…"
        ...
        <div style={{
          ...
          <CustomSelect
            style={{ width: '100%', maxWidth: isMobile ? 'none' : 140 }}
            value={filterClass}
        ...
        <div style={{
          ...
          <button className="btn btn-primary btn-sm" onClick={() => setShowQR(true)} title="Generate portal access QR code for parents"
            style={{ flex: isMobile ? 1 : 'none', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '.4rem' }}>
          ...
          <button className="btn btn-outline btn-sm" onClick={() => navigate('/admin/classes')}
            style={{ width: isMobile ? '100%' : 'auto', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '.4rem' }}>
